package com.example.englandhoang.munimuni.Message;
...
import com.example.englandhoang.munimuni.Account.Friends;
...
public class ChatAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View action_bar_view = inflater.inflate(R.layout.chatall_custom_bar, null);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_PICK && resultCode == RESULT_OK) {
            ...
            final String current_user_ref = "allmessages/";

            DatabaseReference user_message_push = mRootRef.child("allmessages").push();
    ...
    private void loadMoreMessages() {
        ...
        DatabaseReference messageRef = mRootRef.child("allmessages");
    ...
    private void sendMessage() {
        ...
        if (!TextUtils.isEmpty(message)) {
            ...
            String current_user_ref = "allmessages/";

            DatabaseReference user_message_push = mRootRef.child("allmessages")
            ...
            protected void populateViewHolder(final FriendsViewHolder viewHolder, Friends model, int position) {
                ...
                mUsersDatabase.child(list_user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        viewHolder.setImage(userThumb, ChatAllActivity.this);
